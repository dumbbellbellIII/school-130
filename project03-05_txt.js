...
console.log= ("Total Sales: ${totalSales}");   // Variable to store HTML code for table cells used to create bar chart
   
   // Calculate the percent of total sales for a particular phone model
   function addtoTotal (sale) {
      totalSales += sale;
   }
   let barPercent = Math.round((sales[i] / totalSales) * 100);   // Variable that will define the class of td elements used in creating the bar chart cells.
  //define class of td elements
   let cellTag;
